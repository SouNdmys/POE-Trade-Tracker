...
",
    ...
    exchange_settings_hint: "left: how many days of history the first pull reaches back (a configured season start caps it). right: hourly detail is folded into daily lines, then kept this many days before cleanup -- daily lines are kept forever.",
...
",
    ...
    exchange_settings_hint: "左：第一次同步往回拉多少天的历史（配置了赛季起点就到赛季为止）。右：小时级明细折成日线后再留几天，到期清明细——日线永久保留。",
