...
",
    ...
    tuning_min_bps_note: "below this margin an opportunity is not listed; 100bp is 1%",
    ...
    tuning_verdict_note: "market-relative move past this is a verdict; inside it, holding",
    ...
    tuning_spike_note: "a latest rate this far from the median is a spike or drop",
    tuning_severe_spike_note: "and this far is high severity",
    tuning_wide_spread_note: "a maker-taker spread wider than this is an anomaly",
    tuning_severe_spread_note: "and this wide is high severity",
    tuning_apply: "apply",
...
",
    ...
    tuning_min_bps_note: "利润低于这个数就不进列表，100bp = 1%",
    ...
    tuning_verdict_note: "相对市场移动超过它才判升值或贬值，之内算保值",
    ...
    tuning_spike_note: "最新价偏离中位这么多就算跳价",
    tuning_severe_spike_note: "偏到这个程度算严重跳价",
    tuning_wide_spread_note: "挂单价和立即成交价差超过它就算异常",
    tuning_severe_spread_note: "差到这个程度算严重",
    tuning_apply: "应用",
