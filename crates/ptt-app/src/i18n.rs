...
pub struct Text {
    ...
    pub season_amend: &'static str,
    pub exchange_league_label: &'static str,
    /// 有下拉可选时，文本框那一行的标签：下拉是第一条路，手填是第二条。
    pub exchange_league_or_type: &'static str,
    ...
    pub exchange_detail_mean: &'static str,
    pub exchange_detail_hour_of_day: &'static str,
    pub exchange_detail_by_hours: &'static str,
    pub exchange_detail_peak: &'static str,
    pub exchange_detail_missing: &'static str,
    pub exchange_hover_point: &'static str,
    pub exchange_hover_bucket: &'static str,
    pub exchange_hover_gap: &'static str,
    pub exchange_hover_hour_of_day: &'static str,
    ...
    pub exchange_league_rows_missing: &'static str,
    pub exchange_leagues_in_data: &'static str,
    ...
    pub exchange_reconcile_tag: &'static str,
    pub exchange_reconcile_summary: &'static str,
    pub exchange_reconcile_unmatched: &'static str,
    pub exchange_reconcile_none: &'static str,
    pub exchange_reconcile_pair: &'static str,
    pub exchange_reconcile_mapping: &'static str,
    pub exchange_reconcile_worse: &'static str,
    pub exchange_reconcile_better: &'static str,
    pub exchange_reconcile_sporadic: &'static str,
    pub exchange_as_of_label: &'static str,
    pub exchange_as_of_apply: &'static str,
    pub exchange_as_of_now: &'static str,
    pub exchange_historical_tag: &'static str,
    pub exchange_export: &'static str,
    pub exchange_export_prompt: &'static str,
    ...
    pub settings_corrupt_notice: &'static str,
    pub settings_future_schema_notice: &'static str,
    pub pulse_unavailable: &'static str,
    pub rollup_failed: &'static str,
    pub watch_needs_calibration: &'static str,
    pub fault_storage_hint: &'static str,
    pub loading_label: &'static str,
    pub client_lang_en: &'static str,
    pub client_lang_zh_tw: &'static str,
    ...
    pub radar_segment_exchange: &'static str,
    pub radar_segment_capture: &'static str,
    pub exchange_radar_band_hour: &'static str,
    pub exchange_radar_band_behind: &'static str,
    pub exchange_radar_band_assets: &'static str,
    pub exchange_radar_band_markets: &'static str,
    pub exchange_radar_capture_group: &'static str,
    pub exchange_radar_queued: &'static str,
    pub exchange_radar_pin_reason: &'static str,
...
impl Text {
    ...
    fn fields(&self) -> Vec<(&'static str, &'static str)> {
        vec![
            ...
            ("season_amend", self.season_amend),
            ("exchange_league_label", self.exchange_league_label),
            ("exchange_league_or_type", self.exchange_league_or_type),
            ...
            ("exchange_range_24h", self.exchange_range_24h),
            ...
            (
                "exchange_detail_window_volume",
                self.exchange_detail_window_volume,
            ),
            ("exchange_detail_mean", self.exchange_detail_mean),
            (
                "exchange_detail_hour_of_day",
                self.exchange_detail_hour_of_day,
            ),
            ("exchange_detail_by_hours", self.exchange_detail_by_hours),
            ("exchange_detail_peak", self.exchange_detail_peak),
            ("exchange_detail_missing", self.exchange_detail_missing),
            ("exchange_hover_point", self.exchange_hover_point),
            ("exchange_hover_bucket", self.exchange_hover_bucket),
            ("exchange_hover_gap", self.exchange_hover_gap),
            (
                "exchange_hover_hour_of_day",
                self.exchange_hover_hour_of_day,
            ),
            ...
            (
                "exchange_league_rows_missing",
                self.exchange_league_rows_missing,
            ),
            ("exchange_leagues_in_data", self.exchange_leagues_in_data),
            ...
            ("exchange_reconcile_tag", self.exchange_reconcile_tag),
            (
                "exchange_reconcile_summary",
                self.exchange_reconcile_summary,
            ),
            (
                "exchange_reconcile_unmatched",
                self.exchange_reconcile_unmatched,
            ),
            ("exchange_reconcile_none", self.exchange_reconcile_none),
            ("exchange_reconcile_pair", self.exchange_reconcile_pair),
            (
                "exchange_reconcile_mapping",
                self.exchange_reconcile_mapping,
            ),
            ("exchange_reconcile_worse", self.exchange_reconcile_worse),
            ("exchange_reconcile_better", self.exchange_reconcile_better),
            (
                "exchange_reconcile_sporadic",
                self.exchange_reconcile_sporadic,
            ),
            ("exchange_as_of_label", self.exchange_as_of_label),
            ("exchange_as_of_apply", self.exchange_as_of_apply),
            ("exchange_as_of_now", self.exchange_as_of_now),
            ("exchange_historical_tag", self.exchange_historical_tag),
            ("exchange_export", self.exchange_export),
            ("exchange_export_prompt", self.exchange_export_prompt),
            ...
            ("settings_corrupt_notice", self.settings_corrupt_notice),
            (
                "settings_future_schema_notice",
                self.settings_future_schema_notice,
            ),
            ("pulse_unavailable", self.pulse_unavailable),
            ("rollup_failed", self.rollup_failed),
            ("watch_needs_calibration", self.watch_needs_calibration),
            ("fault_storage_hint", self.fault_storage_hint),
            ("loading_label", self.loading_label),
            ("client_lang_en", self.client_lang_en),
            ("client_lang_zh_tw", self.client_lang_zh_tw),
            ...
            ("radar_segment_exchange", self.radar_segment_exchange),
            ("radar_segment_capture", self.radar_segment_capture),
            ("exchange_radar_band_hour", self.exchange_radar_band_hour),
            (
                "exchange_radar_band_behind",
                self.exchange_radar_band_behind,
            ),
            (
                "exchange_radar_band_assets",
                self.exchange_radar_band_assets,
            ),
            (
                "exchange_radar_band_markets",
                self.exchange_radar_band_markets,
            ),
            (
                "exchange_radar_capture_group",
                self.exchange_radar_capture_group,
            ),
            ("exchange_radar_queued", self.exchange_radar_queued),
            ("exchange_radar_pin_reason", self.exchange_radar_pin_reason),
...
",
    ...
    season_amend: "fix start date",
    exchange_league_label: "exchange league (GGG name, empty = off)",
    exchange_league_or_type: "or type one",
    ...
    exchange_detail_mean: "mean per hour",
    exchange_detail_hour_of_day: "by hour of day",
    exchange_detail_by_hours: "by hour",
    exchange_detail_peak: "peak {}:00-{}:00 local",
    exchange_detail_missing: "{} hours in the window had no trade",
    exchange_hover_point: "{} · vol {} · price {}",
    exchange_hover_bucket: "{} · vol {} · avg {}",
    exchange_hover_gap: "{} · no trades",
    ...
    exchange_leagues_in_data: "leagues in the data: {}",
    exchange_backfilling: "backfilling history -- the table fills in as it catches up",
    exchange_radar_tag: "new faces",
    exchange_radar_surge: "volume {}x its normal hour",
    exchange_radar_rise: "up {} (market-adjusted)",
    exchange_radar_gap: "listed {} off traded",
    exchange_reconcile_tag: "panel check",
    exchange_reconcile_summary: "last {}d: top-of-book panel price {}/{} inside the official same-hour traded range",
    exchange_reconcile_unmatched: "({} not matched)",
    exchange_reconcile_none: "last {}d: no panel captures to compare",
    exchange_reconcile_pair: "{} -> {} · {}/{} outside",
    exchange_reconcile_mapping: "nearly all outside -- check the mapping/units first",
    exchange_reconcile_worse: "panel {} worse than anything that traded -- post, don't take",
    exchange_reconcile_better: "panel {} better than anything that traded -- likely a misread",
    exchange_reconcile_sporadic: "sporadic, typical {}",
    exchange_as_of_label: "as of",
    exchange_as_of_apply: "view that day",
    exchange_as_of_now: "back to now",
    exchange_historical_tag: "historical view, as of {}",
    exchange_export: "export CSV+JSON",
    exchange_export_prompt: "Export here",
    ...
    fault_prefix: "fault",
    settings_corrupt_notice: "settings file could not be read and was reset to defaults; the broken copy is kept at {}",
    settings_future_schema_notice: "settings were written by a newer version (schema {}); running read-only on defaults",
    pulse_unavailable: "market pulse unavailable, structural warnings are missing from this page: {}",
    rollup_failed: "daily rollup failed, history may be shorter than it should be: {}",
    watch_needs_calibration: "not started: the three regions are not calibrated for this profile. Frame them on the calibrate page (at 2560x1440 the preset button is enough)",
    fault_storage_hint: "the local database could not be used (held by another copy of the app, or damaged); close other copies and refresh",
    loading_label: "reading the book…",
    client_lang_en: "EN",
    client_lang_zh_tw: "zh-TW",
    ...
    radar_segment_exchange: "exchange radar",
    radar_segment_capture: "capture radar",
    exchange_radar_band_hour: "data hour",
    exchange_radar_band_behind: "{} h behind",
    exchange_radar_band_assets: "assets",
    exchange_radar_band_markets: "markets",
    exchange_radar_capture_group: "capture this group",
    exchange_radar_queued: "{} legs queued",
    exchange_radar_pin_reason: "exchange radar · loop {}",
...
",
    ...
    guide_first_run: concat!(
        ...
        "4  ·  come back and press start watch, or hit the watch hotkey without leaving the game - it refuses to start until all three areas are saved\n",
        ...
        "7  ·  name your league in season & storage, exactly as the api spells it (poe 2: the full name; poe 1: the short id, e.g. allflame) - the exchange page fills in on its own within minutes, and says so in red if the name is wrong",
    ),
    guide_pages: concat!(
        ...
        "exchange  ·  the official ledger: hourly volume and price for your league, and a market-wide radar - needs a league name, needs no calibration\n",
        "calibrate  ·  where the three regions sit on your screen, drawn on a screenshot\n",
        "settings  ·  game and language, the overlay, season and storage (with the league name), and the algorithm numbers",
    ),
    ...
    guide_trouble: concat!(
        ...
        "start watch refused  ·  the three areas are not all saved for this profile - at 2560x1440 the preset button on the calibrate page is enough\n",
        "exchange page stays empty  ·  no league name, or a misspelled one; the sync line on that page shows the last failure in red",
    ),
...
",
    ...
    exchange_detail_mean: "每小时均值",
    exchange_detail_hour_of_day: "按时段",
    exchange_detail_by_hours: "按小时",
    exchange_detail_peak: "峰值 {}:00–{}:00（本地）",
    exchange_detail_missing: "窗口内 {} 个小时无成交",
    exchange_hover_point: "{} · 成交 {} · 价 {}",
    exchange_hover_bucket: "{} · 成交 {} · 均价 {}",
    exchange_hover_gap: "{} · 无成交",
    ...
    exchange_leagues_in_data: "数据里有的联赛：{}",
    exchange_backfilling: "正在回补历史——追上来一段表格就多一段",
    exchange_radar_tag: "新面孔",
    exchange_radar_surge: "放量 {} 倍于平时",
    exchange_radar_rise: "升值 {}（已扣大盘）",
    exchange_radar_gap: "挂单价偏离成交价 {}",
    exchange_reconcile_tag: "面板核对",
    exchange_reconcile_summary: "近 {} 天：面板最优价 {}/{} 次落在官方同小时成交区间内",
    exchange_reconcile_unmatched: "（{} 次没对上）",
    exchange_reconcile_none: "近 {} 天：没有面板抓取可比",
    exchange_reconcile_pair: "{} → {} · {}/{} 越界",
    exchange_reconcile_mapping: "几乎全越界——先查映射或单位",
    exchange_reconcile_worse: "面板价比当小时任何成交都差 {}——挂单别吃单",
    exchange_reconcile_better: "面板价比当小时任何成交都好 {}——多半是误读",
    exchange_reconcile_sporadic: "偶发越界，典型偏离 {}",
    exchange_as_of_label: "截至",
    exchange_as_of_apply: "看这天",
    exchange_as_of_now: "回到现在",
    exchange_historical_tag: "历史视角，截至 {}",
    exchange_export: "导出 CSV+JSON",
    exchange_export_prompt: "导出到这里",
    season_vacuum: "压缩数据库",
    ...
    fault_prefix: "故障",
    settings_corrupt_notice: "设置文件无法读取，已重置为默认值；损坏的副本保留在 {}",
    settings_future_schema_notice: "设置由更新版本写入（schema {}），本次以默认值只读运行",
    pulse_unavailable: "市场脉搏不可用，本页缺少结构性警示：{}",
    rollup_failed: "日 rollup 失败，历史可能比应有的短：{}",
    watch_needs_calibration: "未开始：当前档案的三个区域还没校准。请到校准页框好（2560x1440 直接点预设即可）",
    fault_storage_hint: "本地数据库无法使用（被另一个程序实例占用，或已损坏）；关掉其他实例后刷新",
    loading_label: "正在读取盘口…",
    client_lang_en: "EN",
    client_lang_zh_tw: "繁中",
    language_label: "界面语言",
    game_label: "游戏",
    ...
    radar_segment_exchange: "交易所雷达",
    radar_segment_capture: "抓取雷达",
    exchange_radar_band_hour: "数据小时",
    exchange_radar_band_behind: "落后 {} 小时",
    exchange_radar_band_assets: "资产",
    exchange_radar_band_markets: "市场",
    exchange_radar_capture_group: "去抓这组",
    exchange_radar_queued: "已排队 {} 腿",
    exchange_radar_pin_reason: "交易所雷达 · 环 {}",
...
",
    ...
    guide_first_run: concat!(
        ...
        "4  ·  回来点「开始监视」，或者不出游戏直接按监视热键 — 三块区域没保存全，它会拒绝开始\n",
        "5  ·  在游戏里翻你关心的那几对 — 面板停稳了才读，所以每一对多停一秒\n",
        "6  ·  再回到关注列表和雷达；它们只知道你翻过的那几对\n",
        "7  ·  到「赛季与存储」填联赛名，要和官方 api 的写法一模一样（poe 2 填全名；poe 1 填短名，如 allflame）— 交易所页几分钟内自己补齐，名字错了会红字告诉你",
    ),
    guide_pages: concat!(
        ...
        "交易所  ·  官方成交账：你这个联赛每小时的成交量和价格，外加全市场雷达 — 要填联赛名，不用校准\n",
        "校准  ·  三块区域在你屏幕上的位置，画在截图上\n",
        "设置  ·  游戏与语言、浮窗、赛季与存储（联赛名在这里），还有算法那些数",
    ),
    ...
    guide_trouble: concat!(
        ...
        "开始监视被拒绝  ·  当前档案的三块区域没保存全 — 2560x1440 到校准页点一下预设就够\n",
        "交易所页一直是空的  ·  没填联赛名，或者拼错了；那一页的同步行会把上次失败原因用红字写出来",
    ),
