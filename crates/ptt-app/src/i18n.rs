...
pub struct Text {
    ...
    pub tuning_leg_sweep: &'static str,
    ...
    pub tuning_leg_sweep_note: &'static str,
...
impl Text {
    ...
    fn fields(&self) -> Vec<(&'static str, &'static str)> {
        vec![
            ...
            ("tuning_leg_sweep", self.tuning_leg_sweep),
            ...
            ("tuning_leg_sweep_note", self.tuning_leg_sweep_note),
...
",
    ...
    tuning_leg_sweep_note: "a convert leg that has to take this percent of what is listed against it is flagged as sweeping the book; past 100% the page says the listings do not cover the trip at all, which is a fact and not tunable. This is about taking listings now - not about whether an order you list gets taken. Not the same number as thin norm %.",
